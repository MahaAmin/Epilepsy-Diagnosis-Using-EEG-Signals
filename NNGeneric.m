function YPredict = NNGeneric( H, XTrain, train_size, YTrain, XTest, test_size)
...
hidden_layer = 2;   % no. of hidden layers
hidden_layer_neurons = 2;   % no. of neurons in hidden layer
output_layer_neurons = 2;   % no. of neurons in output_layer = number of classes
epochs=50;
costs=zeros(epochs,2);

% Step#0 initialize thetas randomly
theta1=rand(input_layer+1, hidden_layer_neurons);   % theta1 = (21, 2)
theta2=rand(hidden_layer_neurons+1, output_layer_neurons);  % theta2 = (3, 2)
...
z1 = theta1*a0;   % theta1 = (21, 2) --> z1 = (train_size, 2)
...
sigmoidGradient=gd(z);
delta1=delta1 .* [ones(train_size,1) sigmoidGradient];
delta1=delta1(:,2:end);
end
